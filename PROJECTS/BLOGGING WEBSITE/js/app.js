import { doc , collection, getDocs , getDoc} from "https://www.gstatic.com/firebasejs/10.12.4/firebase-firestore.js";
...
async function getUserData() {
    ...
    <div class="absolute right-0 mt-2 w-48 bg-white border border-gray-300 rounded-lg shadow-lg">
        <ul class="py-2">
            ...
            <li><a href="/profile" class="block px-4 py-2 hover:bg-gray-100">Your Profile</a></li>
...
`;
        ...
        loginsignprofile.setAttribute("href", "/profile")
